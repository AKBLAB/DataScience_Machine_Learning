...
## code to obtain mortality counts for Puerto Rico for 2015-2018
...
## estimates against day of the year, all on the same plot, but with 
...
## Predict 2s and 7s in the mnist_27 dataset with just the second covariate. 
## On first inspection it appears the data does not have much predictive power.
## For a regular logistic regression the coefficient for x_2 is not significant.
